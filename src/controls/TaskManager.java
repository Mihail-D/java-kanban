...
public interface TaskManager {
    ...
    void separateTaskAdd(String taskTitle, String taskDescription, String mode, String time);

    void subTaskAdd(String taskTitle, String taskDescription, String parentKey, String time);
